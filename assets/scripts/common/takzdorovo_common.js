...
let changeScreen = (event) => {
  ...
  const commonContentContainers = document.querySelectorAll(
...
document
  .querySelectorAll(".content-container__left-column")
  .forEach((contentContainer) => {
    contentContainer.addEventListener("click", (event) => {
      const target = event.target;

      if (
        target.classList.contains("left-column__button") ||
        target.classList.contains("button__text") ||
        target.classList.contains("button__image")
      ) {
        const commonContentContainers = document.querySelectorAll(
          ".main__content-container"
        );
        ...
        document
          .querySelector(".main__content-container-empty")
          .classList.remove("hidden");
        const tabsContentElements =
          document.querySelectorAll("[data-tabs-field]");
...
document.querySelectorAll(".close-button_green").forEach((button) => {
  button.addEventListener("click", () => {
    ...
    document
      .querySelector(".main__content-container_green")
      .classList.remove("hidden");
  });
});
...
document.querySelectorAll(".close-button_pink").forEach((button) => {
  button.addEventListener("click", () => {
    document
      ...
      .classList.add("hidden");
    document
      .querySelector(".main__content-container_pink")
      .classList.remove("hidden");
  });
});
